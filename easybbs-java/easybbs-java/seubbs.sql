...
INSERT INTO `sys_setting` VALUES ('email', '{\"emailContent\":\"你好，您的邮箱验证码是：%s，15分钟有效\",\"emailTitle\":\"邮箱验证码--SeuBBS\"}');
...
INSERT INTO `sys_setting` VALUES ('register', '{\"registerWelcomInfo\":\"seubbs欢迎你！\"}');
